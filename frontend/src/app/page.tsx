        ...
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">AI-powered Texas Legislative Search</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Instantly find and understand Texas legislative bills using natural language. 
            Ask questions about education, healthcare, taxes, and more.
          </p>
        </div>
      ...
      <footer className="mt-16 border-t border-gray-200 bg-white/50">
        <div className="max-w-4xl mx-auto px-6 py-6">
          <p className="text-center text-gray-500 text-sm">
            Built with Next.js, FastAPI, and Pinecone • Deployed on Vercel and Render
          </p>
        </div>
      </footer>
    </div>
